...
export async function createLink(name: string, destination: string): Promise<Link> {
  return apiRequest<Link>('/links', {
    method: 'POST',
...
export async function updateLink(linkId: string, destination: string): Promise<Link> {
